# Test rename map (2026-07-16)

The suite dropped its historical `phaseNN_` naming so tests carry
self-explanatory names. Historical documents (CHANGES.md, AUDIT.md,
RESEARCH.md, baseline/, attic/) still use the old names; this table
is the bridge. Old result files are preserved in attic/results_prename/.
