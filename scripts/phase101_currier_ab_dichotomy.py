...
SKEPTICISM:
  - The hardcoded A/B function was ~42% wrong.  ALL prior A/B results
    (Phase 98 baselines, Phase 3, Phase 63, Phase 68) may be biased.
...
# ═══════════════════════════════════════════════════════════════════════
# LOOP GRAMMAR — CHUNK PARSER (from Phase 85)
# ═══════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════
# NL CORPUS LOADING (from Phase 100)
# ═══════════════════════════════════════════════════════════════════════
...
def run_analysis():
    pr("=" * 72)
    pr("PHASE 101 — RESOLVE THE CURRIER A/B DICHOTOMY")
    pr("=" * 72)
    pr()
    ...
    # ───────────────────────────────────────────────────────────────────
    pr("─" * 72)
    pr("STEP 2: Build class sequences using Phase 86 clusters")
    pr("─" * 72)
    pr()

    chunk_to_class = load_phase86_clusters()
    pr(f"  Phase 86 clusters loaded: {len(chunk_to_class)} chunk→class mappings")
    ...
    # SAVE RESULTS
    # ───────────────────────────────────────────────────────────────────
    json_path = RESULTS_DIR / 'phase101_currier_ab_dichotomy.json'
    with open(json_path, 'w', encoding='utf-8') as f:
        json.dump(results, f, indent=2, ensure_ascii=False)

    txt_path = RESULTS_DIR / 'phase101_currier_ab_dichotomy.txt'
