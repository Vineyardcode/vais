...
def run_null_model_test(tokens):
    print("=" * 76)
    print("NULL MODEL — COMPOUND DECOMPOSITION ARTIFACT TEST")
    print("=" * 76)
    print()
    ...
    # The set of "real" roots we used in compound_decomposition (N≥10)
    ...
    # MORE STRICT TEST: use only the N≥5 threshold from compound_decomposition
    ...
    if z_score > 2:
        ...
        print(f"  → Random strings decompose JUST AS WELL. compound_decomposition compounding is AN ARTIFACT.")
...
def run_distribution_blend_test(tokens):
    print()
    print("=" * 76)
    print("DO COMPOUNDS INHERIT PARENT DISTRIBUTIONS?")
    print("=" * 76)
    print()
    ...
    # Test the specific compounds from compound_decomposition
    test_compounds = [
        ('cheo', 'che', 'o'),
        ('ech', 'e', 'ch'),
        ('heo', 'he', 'o'),
...
def run_h_prefix_permutation(tokens):
    print()
    print("=" * 76)
    print("h- VERBAL PREFIX — PERMUTATION TEST")
    print("=" * 76)
    print()
...
def run_construct_chain_test(tokens):
    print()
    print("=" * 76)
    print("SEMITIC CONSTRUCT-CHAIN TEST (SMIKHUT MURKEVET)")
    print("=" * 76)
    print()
...
def run_full_reparse(tokens):
    print()
    print("=" * 76)
    print("FULL CORPUS RE-PARSE — 5-SLOT MODEL")
    print("=" * 76)
    print()
...
def run_paradigm_tables(tokens):
    print()
    print("=" * 76)
    print("PARADIGM TABLES — STEM × DERIVATIONAL PREFIX")
    print("=" * 76)
    print()
...
def main():
    print("compound_model_validation: SKEPTICAL RE-VALIDATION & REVISED MODEL TEST")
    print("=" * 76)
    ...
    print()
    print("=" * 76)
    print("compound_model_validation: VALIDATION VERDICTS")
    print("=" * 76)
    print()
    ...
    json.dump(results, open(Path("results/compound_model_validation_results.json"), 'w'), indent=2, default=str)
    print(f"\n  Results saved to results/compound_model_validation_results.json")


if __name__ == '__main__':
    import contextlib
    outpath = Path("results/compound_model_validation_output.txt")
