...
CENTRAL QUESTION:
  ...
  Through cluster_entropy_language_match we've established:
    - h_char ≈ 0.65 at glyph level (far below NL 0.82-0.90)
    - NOT explained by homophones (cluster_entropy_language_match)
    - NOT explained by Currier A/B mixing (currier_split_fingerprint)
    - NOT explained by Pelling cipher
    - IS encoding-structural (cluster_entropy_language_match verdict, 85% confidence)
...
# ============================================================
# 1. EVA PARSING (from chunk_fingerprint)
# ============================================================
...
# ============================================================
# 2. LOOP 5-SLOT GRAMMAR (canonical chunk_fingerprint model)
# ============================================================
SLOT1 = {'ch', 'sh', 'y'}
SLOT2_RUNS = {'e'}
SLOT2_SINGLE = {'q', 'a'}
...
def main():
    random.seed(42)
    print("=" * 72)
    print("  slot_grammar_entropy_model — SLOT GRAMMAR AS h_char GENERATIVE MODEL")
    print("=" * 72)
    ...
    print("\n" + "=" * 72)
    print("  slot_grammar_entropy_model VERDICT")
    print("=" * 72)
    ...
    print("\n" + "=" * 72)
    print("  slot_grammar_entropy_model COMPLETE")
    print("=" * 72)
    ...
    with open(os.path.join(RESULTS_DIR, 'slot_grammar_entropy_model.json'), 'w') as f:
        json.dump(results, f, indent=2)

    print(f"\n  Results saved to results/slot_grammar_entropy_model.json")
