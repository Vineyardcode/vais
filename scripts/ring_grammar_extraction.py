...
def part1_word_class_profile(ring_texts):
    """Tag every word and profile the distribution of classes."""
    print("=" * 72)
    print("WORD-CLASS TAGGING")
    print("=" * 72)
...
def part2_positional_grammar(ring_texts):
    """Where in sentences do different word classes appear?"""
    print("\n" + "=" * 72)
    print("POSITIONAL GRAMMAR")
    print("=" * 72)
...
def part3_adjacency_bigrams(ring_texts):
    """What word classes follow what? Build transition matrix."""
    print("\n" + "=" * 72)
    print("WORD-CLASS TRANSITION MATRIX")
    print("=" * 72)
...
def part4_function_word_contexts(ring_texts):
    """Deep analysis of each function word's immediate context."""
    print("\n" + "=" * 72)
    print("FUNCTION WORD CONTEXT WINDOWS")
    print("=" * 72)
...
def part5_clause_segmentation(ring_texts):
...
def part6_sentence_templates(ring_texts):
    """Extract recurring sentence-level templates."""
    print("\n" + "=" * 72)
    print("SENTENCE-LEVEL TEMPLATES")
    print("=" * 72)
...
def part7_suffix_agreement(ring_texts):
    """Do adjacent content words show suffix agreement patterns?"""
    print("\n" + "=" * 72)
    print("SUFFIX AGREEMENT PATTERNS")
    print("=" * 72)
...
def part8_sentence_structure_typology(ring_texts):
    """Classify sentences into structural types based on class patterns."""
    print("\n" + "=" * 72)
    print("SENTENCE STRUCTURE TYPOLOGY")
    print("=" * 72)
...
def part9_comparative_syntax(ring_texts):
    """Compare ring text syntax to natural language expectations."""
    print("\n" + "=" * 72)
    print("COMPARATIVE SYNTAX ANALYSIS")
    print("=" * 72)
...
def part10_synthesis(ring_texts):
    """Pull together findings into a grammatical model."""
    print("\n" + "=" * 72)
    print("GRAMMATICAL MODEL SYNTHESIS")
    print("=" * 72)
...
if __name__ == "__main__":
    ...
    all_classified = part1_word_class_profile(ring_texts)
    part2_positional_grammar(ring_texts)
    transitions = part3_adjacency_bigrams(ring_texts)
    part4_function_word_contexts(ring_texts)
    all_clauses = part5_clause_segmentation(ring_texts)
    part6_sentence_templates(ring_texts)
    part7_suffix_agreement(ring_texts)
    part8_sentence_structure_typology(ring_texts)
    part9_comparative_syntax(ring_texts)
    part10_synthesis(ring_texts)
