...
def main():
    pr("=" * 75)
    pr("paragraph_framing: PARAGRAPH FRAMING ANALYSIS")
    ...
    # ═══════════════════════════════════════════════════════════════════
    # 2. PARAGRAPH-INITIAL ANALYSIS (reconfirm paragraph_initial_analysis)
    # ═══════════════════════════════════════════════════════════════════
    pr("\n" + "=" * 75)
...
""")
  ...
  WHAT WE FOUND:
    1. Paragraph-initial glyphs are STRONGLY concentrated on gallows (p,t,k,f)
       — confirmed from paragraph_initial_analysis.
  ...
  CRITICAL QUESTIONS:
    ...
    d) Could different initial glyphs just be different WORDS that happen
       ...
       → paragraph_initial_analysis showed 451 words appear ONLY paragraph-initially.
...
""")
    ...
    # SAVE RESULTS
    # ═══════════════════════════════════════════════════════════════════
    outpath = RESULTS_DIR / 'paragraph_framing.txt'
    ...
    json_path = RESULTS_DIR / 'paragraph_framing.json'
