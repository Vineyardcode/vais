...
root_lexicon_self_audit self-audit found critical problems:
...
# ══════════════════════════════════════════════════════════════════
# PERMUTATION TEST (Gallows Section Enrichment)
# ══════════════════════════════════════════════════════════════════

def run_permutation_test(tokens, n_perms=1000):
    print("=" * 76)
    print("PERMUTATION TEST — ARE GALLOWS DISTRIBUTIONS REAL?")
    print("=" * 76)
    print()
...
# ══════════════════════════════════════════════════════════════════
# POS RECLASSIFICATION
# ══════════════════════════════════════════════════════════════════

def run_pos_reclassification(tokens):
    print()
    print("=" * 76)
    print("POS RECLASSIFICATION BASED ON DATA")
    print("=" * 76)
    print()
    print("root_lexicon_self_audit found POS mismatches. We reclassify based on prefix distributions.")
...
# ══════════════════════════════════════════════════════════════════
# QOKEDY INVESTIGATION
# ══════════════════════════════════════════════════════════════════

def run_qokedy_investigation(tokens):
    print()
    print("=" * 76)
    print("QOKEDY PATTERN INVESTIGATION")
    print("=" * 76)
    print()
...
def run_long_root_census(tokens):
    print()
    print("=" * 76)
    print("LONG-ROOT CENSUS (3+ chars only)")
    print("=" * 76)
    print()
...
# ══════════════════════════════════════════════════════════════════
# BIGRAM STRUCTURE TEST
# ══════════════════════════════════════════════════════════════════

def run_bigram_test(tokens):
    print()
    print("=" * 76)
    print("BIGRAM STRUCTURE TEST — IS THIS REAL LANGUAGE?")
    print("=" * 76)
    print()
...
def main():
    print("root_significance_tests: STATISTICAL SIGNIFICANCE, POS FIX & LONG-ROOT FOCUS")
    print("=" * 76)
    ...
    print()
    print("=" * 76)
    print("root_significance_tests: OVERALL SUMMARY")
    print("=" * 76)
    print()
    ...
    json.dump(results, open(Path("results/root_significance_tests_results.json"), 'w'), indent=2, default=str)
    print(f"\n  Results saved to results/root_significance_tests_results.json")


if __name__ == '__main__':
    import contextlib
    outpath = Path("results/root_significance_tests_output.txt")
