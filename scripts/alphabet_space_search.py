...
def main():
    ...
    # scales from the control+VMS population (same convention as forgery_tournament)
    ...
    print("=" * 76)
    print("alphabet_space_search — ALPHABET-SPACE SEARCH")
    print("=" * 76)
    ...
    with open(result_path('alphabet_space_search.json'), 'w',
              encoding='utf-8') as fh:
        json.dump({'band_mu': band_mu, 'scales': scales, 'runs': runs},
                  fh, indent=1)
    print("\n  -> results/alphabet_space_search.json")
