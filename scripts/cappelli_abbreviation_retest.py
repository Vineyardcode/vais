...
MOTIVATION:
  abbreviation_shorthand_model tested whether abbreviated Latin matches VMS's global
  fingerprint (h_char, Zipf, Heaps, etc.) and found it CANNOT explain
  h_char = 0.64.  That result stands.

  But latin_inflection_ending_test discovered that VMS endings have three extreme anomalies
  ...
  abbreviation_shorthand_model NEVER tested these metrics.  This is a critical gap because
  ...
  KEY QUESTION: Does abbreviated Latin move TOWARD VMS on the latin_inflection_ending_test
...
# ═══════════════════════════════════════════════════════════════════════
# TEXT LOADING (reused from latin_inflection_ending_test)
# ═══════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════
# STATISTICAL HELPERS (from latin_inflection_ending_test)
# ═══════════════════════════════════════════════════════════════════════
...
def h_char_ratio(words):
    ...
    This is the character conditional entropy ratio — the key abbreviation_shorthand_model metric."""
...
def analyze_corpus(words, label, n_chars_list=[1, 2]):
    """Compute latin_inflection_ending_test metrics for a word list."""
...
def main():
    pr("=" * 80)
    pr("cappelli_abbreviation_retest — Re-testing Cappelli Abbreviation Marks vs VMS Suffixes")
    pr("=" * 80)
    pr()
    pr("Critical revalidation of abbreviation_shorthand_model's methodology:")
    ...
    pr("VMS parser suffix distribution (latin_inflection_ending_test):")
    ...
    # SAVE
    # ═══════════════════════════════════════════════════════════════════
    out_txt = RESULTS_DIR / 'cappelli_abbreviation_retest.txt'
    ...
    out_json = RESULTS_DIR / 'cappelli_abbreviation_retest.json'
