...
def main():
    print("=" * 76)
    print("space_free_segmentation — SEGMENTATION-AGNOSTIC MODELING (does BPE rediscover spaces?)")
    print("=" * 76)
    ...
    with open(result_path('space_free_segmentation.json'), 'w',
              encoding='utf-8') as fh:
        json.dump(out, fh, indent=1)
    print("\n  -> results/space_free_segmentation.json")
