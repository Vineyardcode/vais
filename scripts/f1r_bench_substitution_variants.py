...
RESULTS = ROOT / "results" / "f1r_bench_substitution_variants.txt"
...
# Cappelli positional rules (same as f1r_abbreviation_decode)
...
def main():
    ...
    out = []
    out.append("=" * 80)
    out.append("f1r_bench_substitution_variants — BENCH SUBSTITUTION VARIANT SCAN")
    out.append("=" * 80)
    ...
    out.append("   of a multi-layer encoding (as cappelli_abbreviation_retest suggested at ~30%),")
