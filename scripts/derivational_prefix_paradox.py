...
compound_model_validation established:
...
def run_suffix_selection(tokens):
    print("=" * 76)
    print("SUFFIX SELECTION BY DERIVATIONAL PREFIX")
    print("=" * 76)
    print()
...
def run_line_position(tokens):
    print()
    print("=" * 76)
    print("LINE POSITION BY DERIVATIONAL PREFIX")
    print("=" * 76)
    print()
...
def run_gallows_deriv_interaction(tokens):
    print()
    print("=" * 76)
    print("GALLOWS DETERMINATIVE × DERIV PREFIX INTERACTION")
    print("=" * 76)
    print()
...
def run_bare_prefix_investigation(tokens):
    print()
    print("=" * 76)
    print("BARE PREFIX WORDS (ch, h, sh as stems)")  
    print("=" * 76)
    print()
...
def run_inflection_test(tokens):
    print()
    print("=" * 76)
    print("INFLECTION vs DERIVATION — SAME-LINE TEST")
    print("=" * 76)
    print()
...
def main():
    print("derivational_prefix_paradox: THE DERIVATIONAL PREFIX PARADOX")
    print("=" * 76)
    ...
    print()
    print("=" * 76)
    print("derivational_prefix_paradox: SYNTHESIS")
    print("=" * 76)
    print()
    ...
    json.dump({'status': 'complete'}, open(Path("results/derivational_prefix_paradox_results.json"), 'w'), indent=2)
    print(f"\n  Results saved to results/derivational_prefix_paradox_results.json")


if __name__ == '__main__':
    import contextlib
    outpath = Path("results/derivational_prefix_paradox_output.txt")
