...
RESULTS = ROOT / "results" / "positional_frequency_language_match_positional_frequency_match.txt"
...
def main():
    out = []
    out.append("=" * 80)
    out.append("positional_frequency_language_match — POSITIONAL FREQUENCY MATCHING ACROSS LANGUAGES")
    out.append("=" * 80)
    out.append("")
