...
def part1_terms(data):
    print("=" * 70)
    print("Egyptian Terms/Bounds — do term rulers shape label morphology?")
    print("=" * 70)
...
# ── Bright/Dark/Smoky/Void Quality ───────────────────────────────

def part2_quality(data):
    print("\n" + "=" * 70)
    print("Bright/Dark/Smoky/Void — do degree qualities shape labels?")
    print("=" * 70)
...
# ── Masculine/Feminine Degrees ───────────────────────────────────

def part3_gender(data):
    print("\n" + "=" * 70)
    print("Masculine/Feminine Degrees — does gender predict suffix?")
    print("=" * 70)
...
def part4_mansions(data):
    print("\n" + "=" * 70)
    print("Lunar Mansions — do mansion boundaries shape labels?")
    print("=" * 70)
...
def part5_correlation(data):
    print("\n" + "=" * 70)
    print("Multi-System Correlation — which system best predicts labels?")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    part3_gender(data)
    part4_mansions(data)
    part5_correlation(data)
    part6_synthesis(data)
