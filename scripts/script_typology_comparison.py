...
# ═══════════════════════════════════════════════════════════════════════
# VMS CHUNK PARSING (from chunk_fingerprint/98)
# ═══════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════
# VMS TEXT EXTRACTION (from chunk_fingerprint/98)
# ═══════════════════════════════════════════════════════════════════════
...
def run_analysis():
    pr("=" * 72)
    pr("script_typology_comparison — SCRIPT TYPOLOGY COMPARISON")
    pr("=" * 72)
    pr()
    ...
    json_path = RESULTS_DIR / 'script_typology_comparison.json'
    with open(json_path, 'w', encoding='utf-8') as f:
        json.dump(save_data, f, indent=2, default=str)
    pr(f"\n  Results saved to {json_path}")

    txt_path = RESULTS_DIR / 'script_typology_comparison.txt'
