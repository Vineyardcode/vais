...
# ══════════════════════════════════════════════════════════════════
# MORPHOLOGICAL PIPELINE (identical to root_lexicon_expansion)
# ══════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════
# VOCABULARY (root_lexicon_expansion state — 33 confirmed + 7 compounds)
# ══════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════
# SHORT-ROOT COVERAGE AUDIT
# ══════════════════════════════════════════════════════════════════

def run_short_root_audit(tokens):
    print("=" * 76)
    print("SHORT-ROOT COVERAGE AUDIT")
    print("=" * 76)
    print()
...
# ══════════════════════════════════════════════════════════════════
# GRAMMATICAL CONSISTENCY CHECK
# ══════════════════════════════════════════════════════════════════

def run_grammar_check(tokens):
    print()
    print("=" * 76)
    print("GRAMMATICAL CONSISTENCY CHECK")
    print("=" * 76)
    print()
...
# ══════════════════════════════════════════════════════════════════
# SECTION SPECIFICITY TEST
# ══════════════════════════════════════════════════════════════════

def run_section_specificity(tokens):
    print()
    print("=" * 76)
    print("SECTION SPECIFICITY TEST")
    print("=" * 76)
    print()
...
def run_translation_coherence(tokens):
    print()
    print("=" * 76)
    print("TRANSLATION COHERENCE TEST")
    print("=" * 76)
    print()
...
# ══════════════════════════════════════════════════════════════════
# PROVISIONAL ROOT AUDIT
# ══════════════════════════════════════════════════════════════════

def run_provisional_audit(tokens):
    print()
    print("=" * 76)
    print("PROVISIONAL ROOT AUDIT")
    print("=" * 76)
    print()
...
def run_confidence_summary():
    print()
    print("=" * 76)
    print("HONEST CONFIDENCE LEVELS")
    print("=" * 76)
    print()
...
def main():
    print("root_lexicon_self_audit: RIGOROUS SELF-AUDIT & FALSIFICATION")
    print("=" * 76)
    ...
    print()
    print("=" * 76)
    print("root_lexicon_self_audit: OVERALL VERDICT")
    print("=" * 76)
    print()
    ...
    # Save results
    outpath = Path("results/root_lexicon_self_audit_output.txt")
    jsonpath = Path("results/root_lexicon_self_audit_results.json")
