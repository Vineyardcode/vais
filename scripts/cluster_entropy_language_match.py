...
clusters (chunk_equivalence_classes, k=25) normalize the h_char anomaly?
...
# ============================================================
# 1. EVA PARSING (from chunk_fingerprint/86)
# ============================================================
...
# ============================================================
# 2. CLUSTER ASSIGNMENTS (chunk_equivalence_classes, k=25)
# ============================================================
CLUSTER_MAP = {}
...
print("=" * 70)
print("cluster_entropy_language_match: CLUSTER-LEVEL h_char + LANGUAGE MATCHING")
print("=" * 70)
...
print(f"\n{'='*70}")
print("cluster_entropy_language_match COMPLETE")
print(f"{'='*70}")
