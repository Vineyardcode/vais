...
recipe/medical origin for the VMS:
  ...
  4. cross_script_fingerprint: German (Goethe's Faust) ranked 4th closest to VMS
...
# ═══════════════════════════════════════════════════════════════════════
# FINGERPRINT FUNCTIONS (from abjad_hypothesis)
# ═══════════════════════════════════════════════════════════════════════
...
def main():
    pr("=" * 76)
    pr("german_genre_fingerprint — MEDIEVAL GERMAN GENRE-MATCHED FINGERPRINT TEST")
    pr("=" * 76)
    pr()
    ...
    pr("  No natural language or encoding model has reproduced this (forward_process_models).")
    ...
    pr("  german_genre_fingerprint tests RELATIVE closeness, not identity.")
    pr()
    ...
    # ── Save ──────────────────────────────────────────────────────────
    outpath = RESULTS_DIR / 'german_genre_fingerprint.txt'
