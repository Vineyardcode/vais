...
evidence_synthesis declared "diminishing returns" and wrote a synthesis. 
synthesis_stress_test asks: IS THE SYNTHESIS WRONG?
...
print("\n" + "=" * 70)
print("synthesis_stress_test COMPLETE — ATTACKING THE SYNTHESIS")
print("=" * 70)
