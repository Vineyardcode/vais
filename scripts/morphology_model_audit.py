...
def run_s_prefix_test(tokens):
    print("=" * 76)
    print("IS GRAM PREFIX 's' A REAL MORPHEME?")
    print("=" * 76)
    print()
    ...
    # should match 'sh' as deriv prefix in other contexts (e.g., from suffix_bug_cascade_audit)
...
def run_all_gram_prefix_validation(tokens):
    print()
    print("=" * 76)
    print("ARE ALL GRAM PREFIXES REAL?")
    print("=" * 76)
    print()
...
def run_echain_test(tokens):
    print()
    print("=" * 76)
    print("DOES E-CHAIN COLLAPSE DESTROY MEANINGFUL INFO?")
    print("=" * 76)
    print()
...
def run_stem_e_test(tokens):
    print()
    print("=" * 76)
    print("IS STEM 'e' A REAL MORPHEME OR PARSING RESIDUE?")
    print("=" * 76)
    print()
...
def run_suffix_groupings(tokens):
    print()
    print("=" * 76)
    print("DO THE 10 SUFFIXES CLUSTER FUNCTIONALLY?")
    print("=" * 76)
    print()
...
def main():
    print("morphology_model_audit: ARE THE REMAINING MODEL ASSUMPTIONS VALID?")
    print("=" * 76)
    ...
    json.dump({'status': 'complete'},
              open(Path("results/morphology_model_audit_results.json"), 'w'), indent=2)
    print(f"\n  Results saved to results/morphology_model_audit_results.json")


if __name__ == '__main__':
    import contextlib
    outpath = Path("results/morphology_model_audit_output.txt")
